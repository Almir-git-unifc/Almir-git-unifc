export const RANK_ICONS = {
  ...
  AA: `<svg  width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 418 512.098" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd">
         <path fill="#1b70d0" d="M89.487 249.494L0 95.776 76.012.004h.242L82.8 11.187l-1.348-2.221L209 198.125c-35.123 6.917-66.085 25.43-88.722 51.369z"/>
         <path fill="rgba(13, 42, 95, 1)" d="M341.642 0L418 95.776l-89.519 153.682c-22.587-25.893-53.454-44.369-88.471-51.317L209 198.125l-.772  0h.375z"/>
         ...
         <text x="209" y="270" fill="#000000" text-anchor="middle" font-size="18" font-weight="bold">
            Parabéns
         </text>
       </svg>`,
